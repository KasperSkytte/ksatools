#' @title Get or set the column classes of a dataframe
...
#' @return A dataframe containing the column classes of the provided dataframe, or a dataframe with coerced columns
#' @export
#'
#' @examples
#' df <- iris[1:10,]
